...
async function interact() {
    ...
    receiverBalance = await dustinTokenContract.methods.balanceOf(receiverAddress).call();
    console.log({receiverBalance});

    rs = await dustinTokenContract.methods.transfer(receiverAddress, 200000).send({
        from: sendAddress,
        gas: 300000, // max gas
